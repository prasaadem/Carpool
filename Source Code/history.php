...
$ins_query="DELETE FROM booking WHERE book_id=$id";
...
<?php
$count=1;
$sel_query="select * from Ride_Meter r join booking b on r.Ride_id=b.book_id where b.user_name='".$_SESSION["username"] ."';";$result = mysqli_query($con,$sel_query);
...
<p><input name="submit" type="submit" value="Cancel" /></p>
</form>
